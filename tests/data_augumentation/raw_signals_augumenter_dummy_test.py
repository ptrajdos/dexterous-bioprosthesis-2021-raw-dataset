...
from dexterous_bioprosthesis_2021_raw_datasets.data_augumentation.raw_signals_augumenter_dummy import RawSignalsAugumenterDummy
...
class RawSignalsAugumenterDummyTest(RawSignalsAugumenterTest):
    ...
    def get_augumenter(self):
        return RawSignalsAugumenterDummy()