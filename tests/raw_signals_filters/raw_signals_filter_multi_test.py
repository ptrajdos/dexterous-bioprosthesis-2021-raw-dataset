...
from dexterous_bioprosthesis_2021_raw_datasets.raw_signals_filters.raw_signals_filter_multi import RawSignalsFilterMulti
...
class RawSignalsFilterMultiTest(RawSignalsFilterTest):
    ...
    def get_filters(self):
        return [RawSignalsFilterMulti(filter_list=[
            RawSignalsFilterButter(),
            RawSignalsFilterButter(low_freq=30, high_freq=450,btype='bandpass'),
