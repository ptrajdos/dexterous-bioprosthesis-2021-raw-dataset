...
from dexterous_bioprosthesis_2021_raw_datasets.raw_signals.raw_signals_np_immutable import RawSignalsNpImmutable
from tests.testing_tools import get_pickled_obj


class RawSignalsNpImmutableTest(unittest.TestCase):

    def test_creation(self):
        try:
            signals = RawSignalsNpImmutable()
    ...
    def generate_sample_data(
        ...
        return RawSignalsNpImmutable(signals)
    ...
    def test_getitem_slices(self):
        ...
        try:
            ...
            self.assertIsNotNone(it, "Object get is None")
            self.assertIsInstance(
                it, IRawSignals, "Object get is not an instance of RawSignals"
            )
        except Exception as ex:
            self.fail("An exception has been caught: {}".format(ex))
    ...
    def test_set_sample_rate(self):
        ...
        try:
            ...
            self.fail("This should have been failed")
    ...
    def test_immutable_append(self):
        ...
        other_signals = self.generate_sample_data(signal_number=5)

        try:
            signals.append(other_signals)
            self.fail("This should have been failed")
        except NotImplementedError:
            pass
        except Exception:
