import unittest
from dexterous_bioprosthesis_2021_raw_datasets.preprocessing.attribute_reorder import AttributeReorder
...
class AttributeReorderTest(unittest.TestCase):

    def get_transformer(self):
        return AttributeReorder()
    ...
    def test_transforms(self):
        ...
        self.assertTrue(Xt.shape[1] == X.shape[1], "There should be the same number of columns!")
